...
const resetPassword = async (req, res, model, moduleName) => {
  try {
    ...
    Best Regards <br> Marefiya Support Team <br><br>
    <a href="http://marefiya.com" target="_blank">
    <img src="http://marefiya.com/logo.png" alt="Marefiya Logo" style="width: 150px; height: auto;">
    </a><br>
